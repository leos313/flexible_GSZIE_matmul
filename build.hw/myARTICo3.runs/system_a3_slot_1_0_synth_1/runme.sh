...
HD_PWD='/home/leonardo/Desktop/artico_spider/artico3/demos/flexible_GSZIE_matmul/build.hw/myARTICo3.runs/system_a3_slot_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_a3_slot_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_a3_slot_1_0.tcl
